  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'robot-float-3': {
          '0%': { transform: 'translate(-100px, 50vh) scale(0.5)', opacity: '0' },
          '20%': { opacity: '0.8' },
          '80%': { opacity: '0.8' },
          '100%': { transform: 'translate(100vw, 45vh) scale(1)', opacity: '0' },
        },
        'robot-float-4': {
          '0%': { transform: 'translate(80vw, 100vh) scale(1.2)', opacity: '0' },
          '20%': { opacity: '0.7' },
          '80%': { opacity: '0.7' },
      ...
      animation: {
        ...
        'robot-float-1': 'robot-float-1 25s linear infinite',
